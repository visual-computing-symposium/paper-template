% クラスファイルの読み込み
% Note: 投稿時には著者情報を削除するためにanonymousオプションを使用することもできる
...
\noindent
This template is mainly targeted at the Japanese language, but it also provides an option to support manuscripts fully written in English.
