% クラスファイルの読み込み
% Note: 投稿時に著者情報を削除するため，次のようにanonymousオプションを使用しても良い
\documentclass[anonymous]{vc}
% Note: カメラレディ提出時には著者情報を表示するため，次のようにanonymousオプションを使用しないようにする
% \documentclass{vc}
...
\begin{abstract}
  本テンプレートは，コンピュータグラフィクス及びその周辺技術に関する学術シンポジウムVisual Computingへの投稿原稿の執筆のために作成されたものである．
  LaTeX版とWord版が用意されており，どちらを使用しても良い．
\end{abstract}
